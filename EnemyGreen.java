...
/**
 * Green enemy that will spawn into the game.
 * <p>
 * Changelog v0.1:
 ...
 * @version 0.2
 */
public class EnemyGreen extends Character
{
    //declare variables
    ...
    /**
     * Constructor for class EnemyGreen.
     */
    public EnemyGreen()
    {
    ...
    private void shoot()
    {
        ...
        {
            //spawn a projectile in the center of the enemy
            getWorld().addObject(new EnemyGreenProjectile(getX(), getY()), getX(), getY());
