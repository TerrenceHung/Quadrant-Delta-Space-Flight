...
/**
 * The yellow enemy that gets spawned in the world.
 * <p>
 * Changelog v0.1:
 ...
 * @version 0.1
 */
public class EnemyYellow extends Character
{
    //declare variables
    ...
    /**
     * Constructor for class EnemyYellow.
     */
    public EnemyYellow()
    {
    ...
    public void act()
    {
        ...
        {
            fireDelay++;
            //if the fire delay counter has reached 5, set fireProjectile to false and reset delay counter to 0
            if(fireDelay == 5)
            {
    ...
    private void shoot()
    {
        ...
        if(!(fireProjectile || exploding))
        {
            ...
            getWorld().addObject(new EnemyYellowProjectile(getX(), getY() + 30), getX(), getY() + 30);
